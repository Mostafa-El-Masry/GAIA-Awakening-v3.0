...
export const items: NewsItem[] = [
  ...
  id: "w14",
  date: "2026-08-10",
  title: "GAIA Awakening · v3.0 begins",
  tags: ["roadmap", "v3.0", "core"],
  body:
    "GAIA Awakening v3.0 (Core Brain + Daily Thread) starts: a time-aware daily log for health, wealth, learning, work, and memories.",
},
{
    id: "w13",
    date: "2026-08-09",
